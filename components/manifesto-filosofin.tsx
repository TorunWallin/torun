/**
 * ManifestoFilosofin — Slår ihop "Hej, jag är Torun" + "Filosofin" i EN sektion
 * med EN sömlös sticky rosa rådjur-bakgrund. Inget jack mellan dem.
 */
...
export function ManifestoFilosofin() {
  return (
    <section id="manifesto" className="relative">
      {/* EN sticky bakgrund som täcker BÅDE manifesto- och filosofi-innehållet */}
      ...
      {/* ============ DEL 2: FILOSOFIN — SAMMA BAKGRUND ============ */}
      <div id="filosofi" className="relative z-10 px-6 md:px-16 pb-24 md:pb-36">
        <div className="relative max-w-[1120px] mx-auto text-center">
          ...
          <Reveal delay={220}>
            <p className="font-merriweather italic text-[18px] md:text-[20px] text-black/75 max-w-[600px] mx-auto mb-16 leading-[1.5]">
