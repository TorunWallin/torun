...
export function AboutTeaser() {
  return (
    <section id="om" className="relative">
      ...
      {/* Skrollbart innehåll */}
      <div className="relative z-10 px-6 py-20 md:px-16 md:py-64">
          ...
          <div className="relative overflow-hidden rounded-[32px] md:rounded-[40px] border border-white/50 bg-white/30 px-6 py-10 shadow-[0_8px_40px_rgba(255,79,196,0.12),inset_0_1px_0_rgba(255,255,255,0.7)] backdrop-blur-2xl md:px-16 md:py-16">
            ...
            <div className="relative">
              ...
              <div className="mt-10">
                ...
                >
                  <span className="block transition-transform duration-300 group-hover:-translate-x-2">Skicka ett mejl</span>
